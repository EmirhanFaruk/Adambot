...
# Modification date: Mon Nov 28 19:36:30 2022
...
ana_pencere = pygame.display.set_mode((0, 0), pygame.FULLSCREEN)
...
sol_dugme = Dugme(int(monitor_buyuklugu[0]*0.05), int(monitor_buyuklugu[1]*0.6), int(monitor_buyuklugu[0]*0.1), int(monitor_buyuklugu[1]*0.3), (150, 150, 150), "<")
sag_dugme = Dugme(int(monitor_buyuklugu[0]*0.15), int(monitor_buyuklugu[1]*0.6), int(monitor_buyuklugu[0]*0.1), int(monitor_buyuklugu[1]*0.3), (150, 150, 150), ">")
